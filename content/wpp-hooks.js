...
window.whl_hooks_main = () => {
    ...
    function salvarMensagemRecuperada(msg) {
        ...
        const entrada = {
            ...
            from: from,
            body: body,
            type: detectMessageType(body, mediaType), // ← USAR DETECÇÃO
            mediaType: mediaType, // NOVO: tipo de mídia original
            mediaData: mediaData, // NOVO: dados base64 da mídia
            mimetype: mimetype,   // NOVO: mimetype
            filename: filename,   // NOVO: nome do arquivo
            timestamp: Date.now()
        };
