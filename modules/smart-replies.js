...
(function() {
    ...
    const CONFIG = {
        ...
        SUGGESTIONS_COUNT: 3,
        SENTIMENT_KEYWORDS: {
            positive: ['obrigado', 'ótimo', 'excelente', 'perfeito', 'adorei', 'maravilhoso', 'parabéns', 'top'],
            negative: ['problema', 'ruim', 'péssimo', 'horrível', 'reclamar', 'insatisfeito', 'cancelar', 'devolver'],
                ...
                <div style="display:grid;gap:12px">
                    <div>
                        ...
                        <select id="sr-mode" class="mod-input mod-select">
                            ...
                            <option value="semi_auto" ${state.mode === 'semi_auto' ? 'selected' : ''}>⚡ Semi-Automático</option>
                            <option value="full_auto" ${state.mode === 'full_auto' ? 'selected' : ''}>🤖 Totalmente Automático</option>
                        </select>
                    </div>
                    <div>
